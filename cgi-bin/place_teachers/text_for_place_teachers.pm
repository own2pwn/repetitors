...
sub text_for_place_teachers {
  ...
  <p class='paragraph bukviza'>
    Здесь вы можете сделать заказ на размещение своего резюме репетитора
    (<b style='color:black;font-family:Georgia,serif'>бесплатно</b>).
    После этого в самый короткий срок с Вами свяжется наш менеджер.
    Мы бесплатно создадим для Вас интернет-страницу,
    которая в дальнейшем будет рекламировать Ваши услуги также совершенно бесплатно для Вас.
  </p>
  <p>
    Ученики для каждого репетитора подбираются в удобном для него районе Москвы
    и ближайшем Подмосковье,что позволит существенно экономить Ваше время и силы.
    Вы сами определяете время и стоимость занятий.
